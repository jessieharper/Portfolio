...
const Projects = (props: IMask): JSX.Element => {
  ...
  return (
    <section className="relative sm:h-[100vh] h-[160vh] w-[100vw] sm:mt-44 lg:overflow-hidden overflow-x-scroll">
            ...
            >
              <div className="sm:absolute sm:inset-0 z-10 sm:grid sm:place-content-center">
                <div className="flex lg:flex-row flex-col items-center justify-center">
                  ...
                  <h3
                    className="title uppercase lg:[writing-mode:vertical-lr] lg:rotate-180 font-black backdrop-blur-lg mr-8 font-poppins my-10 sm:my-0"
                    onMouseEnter={() => {
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <div className="flex sm:flex-row flex-col relative">
                      ...
                      {card.link && (
                        ...
                        >
                          <button className="sm:absolute sm:right-[60px] bottom-[-10px] w-[200px] border-4 p-2 border-background bg-no-repeat rounded-full text-lg bg-text">
                            Visit site
                          </button>
                        </a>
                      )}
